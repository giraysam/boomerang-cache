...
(function (root, factory) {
    ...
    BoomerangCache.prototype.hasExpired = function (key) {
        ...
        var itemValue = this.storage.getItem(key),
            expireValue;

        if (this.options.encrypt == true && itemValue) {
            itemValue = CryptoJS.AES.decrypt(itemValue, "Boomerang Cache Secret Key").toString(CryptoJS.enc.Utf8);
        }
    ...
    api = (function() {
        ...
        return {
             ...
             * @param {object} options - storage: (local | session) - encrypt: (true | false)
             *
             * @example
    ...
    BoomerangCache.prototype.api = {
        ...
        local: {
            ...
            getAll: function(namespace, encrypt) {
                ...
                while (i--) {
                    ...
                    if (keySplit[0] == namespace) {
                        ...
                        if (encrypt == true) {
                            val = CryptoJS.AES.decrypt(val, "Boomerang Cache Secret Key").toString(CryptoJS.enc.Utf8);
                        }

                        values[keySplit[1]] = JSON.parse(val)["value"];
                    }
                }
        ...
        session: {
            ...
            getAll: function(namespace, encrypt) {
                ...
                while (i--) {
                    ...
                    if (keySplit[0] == namespace) {
                        val = sessionStorage.getItem(keys[i]);
    ...
    BoomerangCache.prototype.set = function(key, value, seconds) {
        ...
        if (this.options.encrypt == true) {
            itemValue = CryptoJS.AES.encrypt(JSON.stringify(itemValue), "Boomerang Cache Secret Key");
        }
        else {
        ...
        // if value is string
        this.storage.setItem(namespaceKey, itemValue);
        return value;
    };
    ...
    BoomerangCache.prototype.get = function(key, defaultValue) {
        ...
        var itemValue = this.storage.getItem(namespaceKey);
    ...
    BoomerangCache.prototype.getAll = function() {
        ...
        return this.storage.getAll(this.namespace, this.options.encrypt);
    };
    ...
    BoomerangCache.prototype.length = function() {
        ...
        return Object.keys(this.storage.getAll(this.namespace, this.options.encrypt)).length;
    };
